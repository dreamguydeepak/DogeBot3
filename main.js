...
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('<>','red'), color('Thanks For Using Deepak Bot', 'white'))
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      try {
        ...
        DogeXeonOP.sendMessage(anu.jid, "Hello everyone, am Deepak Bot, ready to help you here", "conversation")
      }
      ...
      welcomeButt = { contentText: `${teks}`, footerText: `Deepal Bot`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `Deepak Bot`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
